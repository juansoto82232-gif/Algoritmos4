...
#Examen A algoritmos solucion
# PUNTO 1a: Clase Nodo (Pagina)

class Pagina:
    def _init_(self, url, titulo, tiempo):
        self.url = url
        self.titulo = titulo
        self.tiempo = tiempo
...
class Historial:
    def _init_(self):
        self.inicio = None  # la página más reciente
    ...
    def buscar_por_dominio(self, texto):
        ...
        nueva_lista.inicio = self._buscar_rec(self.inicio, texto.lower())
        return nueva_lista
    ...
    def _buscar_rec(self, nodo, texto):
        ...
        if texto in nodo.url.lower():
            nuevo = Pagina(nodo.url, nodo.titulo, nodo.tiempo)
    ...
    def _eliminar_rec(self, nodo, minimo):
        ...
        if nodo.tiempo < minimo:
            return nodo.siguiente  # se elimina
        else:
            return nodo